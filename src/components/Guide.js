  ...
  return (
    <div style={{ width: "100vw", minHeight: "100vh", background: "#f8fafc", overflowX: "hidden", position: "relative" }}>
      ...
      <section style={{ width: "100vw", minHeight: "100vh", background: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", paddingTop: "4.5rem", paddingBottom: "4rem" }}>
        ...
        `}</style>
        <button className="find-therapist-btn" style={{ marginTop: "2.5rem", marginBottom: "2.5rem", padding: "12px 44px", fontSize: 28, fontWeight: 800, borderRadius: 32, letterSpacing: "-0.01em" }} onClick={() => setShowOnboarding(true)}>
        ...
        <div style={{
          ...
          {DOCTORS.map((doc, idx) => {
            ...
            return (
              ...
              >
                <video
                  src={process.env.PUBLIC_URL + `/intro_${idx+1}.mp4`}
                  style={{ width: "100%", height: "100%", objectFit: "cover" }}
                  muted
                  playsInline
                  preload="metadata"
                  poster={process.env.PUBLIC_URL + `/${thumb}`}
                />
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1.2, background: "#000", display: "flex", alignItems: "center", justifyContent: "center", height: "100%" }}>
                <video
                  src={process.env.PUBLIC_URL + `/intro_${selected+1}.mp4`}
